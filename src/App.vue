...
// 监听storage事件，当token发生变化时，自动登录或退出
...
<template>
  <div>
    ...
    <div class="pt-16 flex pb-84">
      ...
      hover:text-base-100 focus:text-base-100 active:text-base-100 outline-none">
      ...
      hover:text-base-100 focus:text-base-100 active:text-base-100 outline-none">
            ...
            <div class="grid place-items-center ml-auto justify-self-end">
              <div class="relative grid items-center font-sans font-bold uppercase whitespace-nowrap select-none bg-primary-content text-primary py-1 px-2 text-xs rounded-full">
                <span>14</span>
              </div>
            </div>
          </div>
      ...
      <!-- 主体内容区域 -->
      <div class="flex-1 ml-0 lg:ml-80" style="width: calc(100% - 320px);">
          <router-view />
      </div>
    </div>
    <bar-player/>
